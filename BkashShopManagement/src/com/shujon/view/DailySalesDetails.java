...
public class DailySalesDetails extends javax.swing.JFrame {
   ...
   public void displayDataIntoTable() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -30, 810, 580));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          try {
              ...
              Logger.getLogger(DailySalesDetails.class.getName()).log(Level.SEVERE, null, ex);
          }
