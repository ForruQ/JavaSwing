...
public class SummaryDetails extends javax.swing.JFrame {
   ...
   public void displayDataIntoTable() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      try {
          ...
          Logger.getLogger(SummaryDetails.class.getName()).log(Level.SEVERE, null, ex);
      }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SummaryDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
