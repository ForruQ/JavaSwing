...
public class EditionView extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Edition author = new Edition(txtName.getText().trim());
        editionService.save(author);
        displayDataIntoTable();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       Edition edition = new Edition(Integer.parseInt(txtId.getText()), txtName.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (i == 0) {
            editionService.delete(Integer.parseInt(txtId.getText()));
            displayDataIntoTable();
