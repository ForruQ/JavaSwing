...
public class BookRecieveView extends javax.swing.JFrame {

    AdapterService bookRecieveService = new BookRecieveServiceImpl();

    public BookRecieveView() {
        initComponents();
    ...
    public void displayDataIntoTable() {
        ...
        List<BookRecieve> list = bookRecieveService.getList();
    ...
    private void initComponents() {
        ...
        tblDisplay.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Book Id", "Student Id", "Return Date", "Quantity"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        BookRecieve bookRecieve = new BookRecieve(bookId, studetnId, returnDate, qty);
        bookRecieveService.save(bookRecieve);
        displayDataIntoTable();
        JOptionPane.showMessageDialog(null, "Recieved Successfully");
        reset();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       int bookId = Integer.parseInt(txtBookId.getText().trim());
        ...
        BookRecieve bookRecieve = new BookRecieve(bookId, studetnId, returnDate, qty);
        bookRecieveService.update(bookRecieve);
        displayDataIntoTable();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (i == 0) {
            bookRecieveService.delete(Integer.parseInt(txtId.getText()));
            displayDataIntoTable();
    ...
    private void tblDisplayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDisplayMouseClicked
        ...
        chooserReturnDate.setDateFormatString(String.valueOf(model.getValueAt(i, 3)));
        txtQty.setText(String.valueOf(model.getValueAt(i, 4)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookRecieveView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
