...
public class AuthorView extends javax.swing.JFrame {
    AdapterService authorServic = new AuthorServiceImpl();
    
    public void displayDataIntoTable() {
        DefaultTableModel model = (DefaultTableModel) tblDisplay.getModel();
        model.setRowCount(0);
        Object[] row = new Object[2];
        List<Author> list = authorServic.getList();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Author author = new Author(txtName.getText().trim());
        authorServic.save(author);
        displayDataIntoTable();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       Author author = new Author(Integer.parseInt(txtId.getText()), txtName.getText());
       authorServic.update(author);
      displayDataIntoTable();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (i == 0) {
            authorServic.delete(Integer.parseInt(txtId.getText()));
            displayDataIntoTable();
