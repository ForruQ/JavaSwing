...
public class DepartmentView extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Department department = new Department(txtName.getText().trim());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       Department department = new Department(Integer.parseInt(txtId.getText()), txtName.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (i == 0) {
            departmentService.delete(Integer.parseInt(txtId.getText()));
            displayDataIntoTable();
