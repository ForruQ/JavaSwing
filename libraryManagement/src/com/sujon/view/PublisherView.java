...
public class PublisherView extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Publisher publisher = new Publisher(txtName.getText().trim());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       Publisher publisher = new Publisher(Integer.parseInt(txtId.getText()), txtName.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (i == 0) {
            publisherService.delete(Integer.parseInt(txtId.getText()));
            displayDataIntoTable();
