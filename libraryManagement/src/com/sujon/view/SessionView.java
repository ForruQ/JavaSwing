...
public class SessionView extends javax.swing.JFrame {
    ...
    public void displayDataIntoTable() {
        ...
        List<Session> list = sessionService.getList();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Session session = new Session(txtName.getText().trim());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       Session session = new Session(Integer.parseInt(txtId.getText()), txtName.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (i == 0) {
            sessionService.delete(Integer.parseInt(txtId.getText()));
            displayDataIntoTable();
