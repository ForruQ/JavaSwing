...
public class LogInView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\dell\\Downloads\\Picture\\images (3).jpeg")); // NOI18N
   ...
   try {
            User user = (User) userService.getUserByUsernameAndPassword(txtUserName.getText().trim(), txtPassword.getText().trim());
